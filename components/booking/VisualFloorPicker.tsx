...
import { Users, CheckCircle2, Ban, Clock, MapPin, Sparkles } from 'lucide-react';
...
export default function VisualFloorPicker({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* 2D Canvas */}
      <div className="relative w-full h-[480px] bg-[#0c1322] border-2 border-slate-800 rounded-3xl overflow-hidden shadow-2xl backdrop-blur-xl">
        {/* Blueprint Grid */}
        <div
          ...
          zoneTables.map((table) => {
            ...
            return (
              <button
                ...
                style={{
                  position: 'absolute',
                  left: `${Math.min(table.positionX || 50, 700)}px`,
